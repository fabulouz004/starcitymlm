...
if (isset($_GET['update_info'])){
    ...
    if($mobile != ''){
        $query = mysqli_query($con,"update users set `mobile`= '$mobile' where `email` = '$userid' limit 1");

        echo '<script>alert("Upated Successfully");window.location.assign("user-profile.php");</script>';

    }else{
        echo '<script>alert("Please fill in the field correctly.");window.location.assign("user-profile.php");</script>';
    }
...
if (isset($_GET['update_bank'])){
    $bank = mysqli_real_escape_string($con,$_GET['account']);

    if($bank != ''){
        $query = mysqli_query($con,"update users set `account`= '$bank' where `email` = '$userid' limit 1");
                        ...
                        <div class="modal-dialog">
                            ...
                            <form method = "get" class="form-inline">
                                <div class="form-group">
                                    <label>Enter New Bank Details</label>
