...
if(isset($_GET['admin-search'])){
    ...
    if (cross_check_mail($theuser)){
        ...
        echo '<script>alert("Invalid User Email");window.location.assign("tree-search.php");</script>';
...
if($search_id!=""){
$query_check = mysqli_query($con,"select * from users where email='$search_id'");
if(mysqli_num_rows($query_check)>0){
$search = $search_id;
}
else{
echo '<script>alert("Invalid - User has recycled.");window.location.assign("tree-search.php");</script>';
}
}
else{
echo '<script>alert("Access Denied");window.location.assign("tree-search.php");</script>';
} 
}
?>
<!DOCTYPE html>
...
if($first_left_user!=""){
?>
<td colspan="2"><a href="tree-search.php?search-id=<?php echo $first_left_user ?>"><i class="fa fa-user fa-4x" style="color:#D520BE"></i><p><?php echo $first_left_user ?></p></a></td>
<?php 
}
else{
?>
...
if($first_right_user!=""){
?>
<td colspan="2"><a href="tree-search.php?search-id=<?php echo $first_right_user ?>"><i class="fa fa-user fa-4x" style="color:#D520BE"></i><p><?php echo $first_right_user ?></p></a></td>
<?php 
}
else{
?>
...
if($second_left_user!=""){
?>
<td><a href="tree-search.php?search-id=<?php echo $second_left_user ?>"><i class="fa fa-user fa-4x" style="color:#361515"></i><p><?php echo $second_left_user ?></p></a></td>
<?php 
}
else{
?>
...
?>
<td><a href="tree-search.php?search-id=<?php echo $second_right_user ?>"><i class="fa fa-user fa-4x" style="color:#361515"></i><p><?php echo $second_right_user ?></p></a></td>
<?php 
}
else{
?>
...
if($third_left_user!=""){
?>
<td><a href="tree-search.php?search-id=<?php echo $third_left_user ?>"><i class="fa fa-user fa-4x" style="color:#361515"></i><p><?php echo $third_left_user ?></p></a></td>
<?php 
}
else{
?>
...
if($thidr_right_user!=""){
?>
<td><a href="tree-search.php?search-id=<?php echo $thidr_right_user ?>"><i class="fa fa-user fa-4x" style="color:#361515"></i><p><?php echo $thidr_right_user ?></p></a></td>
<?php 
}
else{
?>
