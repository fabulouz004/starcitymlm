                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                    	<div class="panel panel-info">
                        	<div class="panel-heading">
                            	<h4 class="panel-title">Current Pin Request</h4>
                            </div>
                            <div class="panel-body">
                            	<?php 
                    ...
                    <div class="col-lg-3">
                    	<div class="panel panel-success">
                        	<div class="panel-heading">
                            	<h4 class="panel-title">Current Cashout Request</h4>
                            </div>
                            <div class="panel-body">
                            	<?php 
								echo  mysqli_num_rows(mysqli_query($con,"select * from cashout_request where `status` = 'open'"));
								?>
                            </div>
                        </div>
                    </div>
