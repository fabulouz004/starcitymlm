...
<head>
    ...
    <title>StarCity Hub  - Income</title>
                	...
                	<div class="col-lg-12">
                    	<div class="table-responsive">
                        	<table class="table table-bordered table-striped">
                                ...
                                <tbody>
								<?php
                                	$query = mysqli_query($con,"select * from income where current_earnings>0");
									if(mysqli_num_rows($query)>0){
										$i=1;
										while($row=mysqli_fetch_array($query)){
											$userid = $row['userid'];
											$amount = $row['current_earnings'];
									...
									?>
                                    	<tr>
                                        	<td colspan="4">No user has current earnings</td>
                                        </tr>
                                    <?php
									}
                                ?>
